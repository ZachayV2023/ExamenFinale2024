...
public class ConfigExceptionHandling
  extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleConflict(Exception ex, WebRequest request) throws NoSuchFieldException {
        ex.printStackTrace();
        // TODO on prend le nom court de l'exception comme corps de la réponse HTTP 400 comme code
        String bodyOfResponse = ex.getClass().getSimpleName() + " - " + ex.getMessage();
        //génère un nombre aléatoire qui contient trois 2
